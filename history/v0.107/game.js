(function () {
            ...
            function drawScore() {
                ctx.font = "30px Arial";
                ctx.fillStyle = "white";
                ctx.fillText("Left: " + state.left.score, 50, 50);
                ctx.fillText("Right: " + state.right.score, canvas.width - 150, 50);
            }
            ...
            function handleCollision() {
                if (state.left.up) {
                    state.ball.vy = -baseBallSpeed() * 1.5;
            ...
            function gameLoop() {
                ...
                if (state.ball.x <= paddleMargin() + ballSize()) {
                    handleCollision();
                } else if (state.ball.x >= canvas.width - paddleMargin() - ballSize()) {
                    resetGame();
                }
