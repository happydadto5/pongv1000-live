(function () {
    ...
    function handleCollision() {
        ...
        if (state.ball.x + ballSize() >= canvas.width) {
            updateScore(); // Implement updateScore function to increase score based on power-ups collected
            resetBall(-1);
        } else if (state.ball.x - ballSize() <= 0) {
            state.right.score += 1;
            resetBall(1);
        }
    }
